package com.example.core.support.ip;
 ...
 *
 * <h2>使用示例
 * <p>Envoy 代理：headerName="x-envoy-external-address", headerValueIsDirectIp=true
 * <p>Nginx 代理：headerName="X-Forwarded-For", headerValueIsDirectIp=false, ipIndex=-2
 *
...
public class ClientIpFilter extends OncePerRequestFilter {
    ...
    /** 请求头的值是否直接对应 IP 地址 */
    @Setter
    private boolean headerValueIsDirectIp;
